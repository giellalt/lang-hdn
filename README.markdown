...
This directory contains source files for the Northern Haida language
...
-   <https://giellalt.uit.no/lang/hdn/NorthernHaida.html> (analyser)
...
The Northern Haida language sources can be acquired using [giella SVN
